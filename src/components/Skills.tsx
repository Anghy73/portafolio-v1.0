  ...
  return (
    <section id="skills" className='relative w-full max-w-3xl h-screen flex flex-col justify-center items-center py-30 mx-auto z-20'>
      ...
      <div className="flex justify-center flex-wrap gap-4">
        ...
        <div title="React" className="flex justify-center items-center gap-2 border-2 border-teal-400 w-fit p-2 px-4 rounded-md shadow-[0px_0px_8px] shadow-teal-400 cursor-pointer"><span><ReactJS></ReactJS></span><span className="font-semibold text-lg text-teal-400 text-shadow-[0px_0px_8px] text-shadow-teal-400">React</span></div>
        <div title="Typescript" className="flex justify-center items-center gap-2 border-2 border-sky-500 w-fit p-2 px-4 rounded-md shadow-[0px_0px_8px] shadow-sky-500 cursor-pointer"><span><TypeScript></TypeScript></span><span className="font-semibold text-lg text-sky-500 text-shadow-[0px_0px_8px] text-shadow-sky-500">Typescript</span></div>
        <div title="TailwindCSS" className="flex justify-center items-center gap-2 border-2 border-sky-500 w-fit p-2 px-4 rounded-md shadow-[0px_0px_8px] shadow-sky-500 cursor-pointer"><span><TailwindCSS></TailwindCSS></span><span className="font-semibold text-lg text-sky-500 text-shadow-[0px_0px_8px] text-shadow-sky-500">TailwindCSS</span></div>
        <div title="Node.js" className="flex justify-center items-center gap-2 border-2 border-green-500 w-fit p-2 px-4 rounded-md shadow-[0px_0px_8px] shadow-green-500 cursor-pointer"><span><Nodejs></Nodejs></span><span className="font-semibold text-lg text-green-500 text-shadow-[0px_0px_8px] text-shadow-green-500">Node.js</span></div>
        <div title="Express" className="flex justify-center items-center gap-2 border-2 border-slate-400 w-fit p-2 px-4 rounded-md shadow-[0px_0px_8px] shadow-slate-400 cursor-pointer"><span><Expressjs></Expressjs></span><span className="font-semibold text-lg text-slate-400 text-shadow-[0px_0px_8px] text-shadow-slate-400">Express</span></div>

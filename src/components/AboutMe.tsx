  ...
  return (
    <section id="about" className='relative w-full max-w-3xl h-full flex flex-col justify-center items-center py-30 mx-auto z-20'>
      ...
      <div className="flex flex-col gap-6 w-full">
        ...
        <p className="font-medium text-left flex justify-center items-center"><span className="min-w-fit text-white/20 text-md mr-3">&#60; p &#62;</span>Estudie en Inacap, como Analista Programador, Aparte de estudiar en diferentes plataformas como platzi, freecodecamp, etc. bla bla bla <span className="text-white/20 text-md min-w-fit ml-2">&#60;/ p &#62;</span></p>
      </div>
    </section>
  )
}
